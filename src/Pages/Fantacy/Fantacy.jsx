    ...
    <Stack m="auto" w="970px" h="1100px" bgColor="black" mt="100px" >
      ...
      <SimpleGrid columns={[1, 1, 2, 2]} spacing={3} justify="center">
        ...
        <Box w={["100%", "70", "95%"]} h="auto" ml={5}>
          ...
          <VStack h="200px" align="left" >
            ...
            <Box border="1px solid #FFB600" w="100%" h="150px" borderRadius="8px" pt={2} bgColor="#FFFFFF33">
              ...
              <HStack justify="space-between" >
                <Box pb={3} border="1px solid yellow" ml="125px" w="150px" h="18px" pl="4px" pr="4px" borderRadius="12px" bgColor="#FFB600" justify="center" ><Text color="black" fontSize="12.4px">start in 6h 57min 39sec  </Text></Box>
          ...
          <Text fontSize={["12px", "14px", "14px"]} p="0px 0px 0px 4px" textColor="grey" align="left" fontWeight="600">LIVE MATCHES</Text>
          <VStack h="150px" align="left" >
            ...
            <Box border="1px solid grey" w="100%" h="120px" borderRadius="8px" pt={2} bgColor="#FFFFFF33">
              ...
              <HStack justify="center" p={2}>
                <Box border="1px solid yellow" w="30px" h="30px"><Image w="35px" h="30px" borderRadius="50%" src="https://www.cricket.com/svgs/images/flag_empty.png" alt="pic" /></Box>
                <Text fontSize="20px" color="#999999" pr="12px" pl="2px">IN-L</Text>
                <Box border="1px solid yellow" w="30px" h="30px" borderRadius="50%" ml="10px" mr="5px" bgColor="#FFB600"><Text color="black">vs</Text></Box>
                <Text fontSize="20px" color="#999999" pl="12px" pr="2px">AU-L</Text>
                <Box border="1px solid yellow" w="30px" h="30px" borderRadius="0%"><Image w="35px" h="30px" borderRadius="50%" src="https://www.cricket.com/svgs/images/flag_empty.png" alt="pic" /></Box>
              </HStack>
              <HStack justify="space-between">
          ...
          <Text fontSize={["12px", "14px", "14px"]} p="0px 0px 0px 4px" textColor="grey" align="left" fontWeight="600">COMPLETED MATCHES</Text>
          <VStack border="1px solid green" h="130px" align="left" >

            <Box border="1px solid grey" w="100%" h="120px" borderRadius="8px" pt={2} bgColor="#FFFFFF33">

              <Text fontSize={["8px", "10px", "14px"]} isTruncated>Eliminator, Caribbean Premier League ,2022</Text>
        ...
        <Box w={["100%", "70%", "95%"]} h="auto" mr="-10px" >
          ...
          <VStack border="1px solid green" h="200px" align="left" mt="20px" >
            ...
            <Box border="1px solid #FFB600" w="100%" h="150px" borderRadius="8px" pt={2} bgColor="#FFFFFF33">
              ...
              <HStack justify="space-between" >
                <Box pb={3} border="1px solid yellow" ml="125px" w="150px" h="18px" pl="4px" pr="4px" borderRadius="12px" bgColor="#FFB600" justify="center" ><Text color="black" fontSize="12.4px">start in 3h 17min 49sec  </Text></Box>
                <Box mr="-80px"><Box><Button mt="-15px" color="yellow" border="none" bgColor="grey.1000"><Icon as={ChevronRightIcon} /></Button></Box></Box>
              </HStack>
              <HStack justify="center" pt="6px">
                <Text fontSize="12px" color="#999999">September 28 2022. |</Text>
          ...
          <VStack border="1px solid green" h="150px" align="left" mt="20px">
          ...
          <VStack border="1px solid green" h="130px" align="left" mt="23px" >
